...
A hardware profile (``platform/shared/config/profiles/<name>/``, plus the
matching ``platform/robot/config/hardware/motors/profiles/<name>/`` for
...
"""platform/shared/config/profiles -- resolved relative to this module's own
