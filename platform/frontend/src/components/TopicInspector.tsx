...
function TopicModal({ topic, onClose }: TopicModalProps) {
  ...
  return createPortal(
    <div className="topic-modal-overlay" onClick={onClose}>
      <div className="topic-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label={topic.topic_name}>
...
export function TopicInspector({ topics }: TopicInspectorProps) {
  ...
  return (
    <>
                ...
                <div className="topic-header" onClick={() => toggleTopic(topic.topic_name)}>
                  ...
                  <div className="topic-meta">
                    ...
                    <button
                      ...
                      onClick={(e) => { e.stopPropagation(); setModalTopicName(topic.topic_name) }}
      ...
      {modalTopic && (
        <TopicModal topic={modalTopic} onClose={() => setModalTopicName(null)} />
      )}
    </>
  )
}
