...
def test_apply_scenario_to_south() -> None:
...
def test_apply_scenario_to_north() -> None:
...
def test_apply_scenario_to_east() -> None:
...
def test_apply_scenario_to_west() -> None:
...
def test_multiple_signs_in_scenario() -> None:
