"""Legacy robot model building (placeholder for future refactoring).

This module preserves the existing robot model construction logic.
It will be further refactored to split robot physics, sensors, and
drivetrain concerns into focused builders.

TODO: Refactor into RobotBuilder, SensorBuilder, and DrivetrainBuilder.
"""
...
# ============================================================================
# Private helper functions (from legacy sdf_builder.py)
# ============================================================================
