...
// from platform/config/robot.toml.
...
// DefaultRobotTOMLPath is platform/config/robot.toml, relative to the
// repo root.
const DefaultRobotTOMLPath = "platform/config/robot.toml"
