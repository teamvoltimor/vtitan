...
// platform/config/navigation/simulation/simulation.toml
...
// platform/config/navigation/simulation/simulation.toml, relative
// to the repo root. No per-component profile overlays -- pass nil
// profileNames to Load.
const DefaultSimulationTOMLPath = "platform/config/navigation/simulation/simulation.toml"
