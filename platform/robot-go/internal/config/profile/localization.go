...
// platform/config/navigation/blind_nav/localization.toml
...
// platform/config/navigation/blind_nav/localization.toml, relative to
// the repo root. No per-component profile overlays -- pass nil profileNames
// to Load.
const DefaultLocalizationTOMLPath = "platform/config/navigation/blind_nav/localization.toml"
