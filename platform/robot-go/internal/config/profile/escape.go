...
// platform/config/navigation/escape/escape.toml
...
// platform/config/navigation/escape/escape.toml, relative to the
// repo root. No per-component profile overlays -- pass nil profileNames to
// Load.
const DefaultEscapeTOMLPath = "platform/config/navigation/escape/escape.toml"
