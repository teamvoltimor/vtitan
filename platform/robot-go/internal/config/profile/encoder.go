...
// platform/config/hardware/motors/encoder.toml
...
// platform/config/hardware/motors/encoder.toml, relative to the repo
// root.
const DefaultEncoderTOMLPath = "platform/config/hardware/motors/encoder.toml"
