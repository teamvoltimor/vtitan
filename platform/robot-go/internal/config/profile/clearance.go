...
// platform/config/navigation/motion/clearance.toml
...
// platform/config/navigation/motion/clearance.toml, relative to the
// repo root. No per-component profile overlays -- pass nil profileNames to
// Load.
const DefaultClearanceTOMLPath = "platform/config/navigation/motion/clearance.toml"
