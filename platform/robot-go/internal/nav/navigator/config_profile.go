...
// platform/config/profiles/<name>/motion/speed.toml, NOT at
...
// speedTOML mirrors platform/config/navigation/motion/speed.toml
...
// headingTOML mirrors platform/config/navigation/motion/heading.toml
...
const (
	speedTOMLPath   = "platform/config/navigation/motion/speed.toml"
	headingTOMLPath = "platform/config/navigation/motion/heading.toml"
	// speedProfilesDir is the directory holding each hardware profile's
	// overlay tree, relative to the repo root.
	speedProfilesDir = "platform/config/profiles"
