...
the Go generator (``platform/gazebo/generator``, ``simgen``) — the same
generator that drives Gazebo and the real robot — so visualizing "scenario N"
here means watching a real official-generator layout, including the actual WRO
2026 36-scenario traffic-sign table (``internal/generate/scenarios.go``).
