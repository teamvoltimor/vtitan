...
Usage:
    python3 scripts/hardware/test_motors.py                  # steering + drive (asks to confirm drive)
    python3 scripts/hardware/test_motors.py --skip-drive      # steering only
    python3 scripts/hardware/test_motors.py --yes             # skip the drive confirmation prompt
    python3 scripts/hardware/test_motors.py --drive-speed 0.2 --drive-duration-s 2.0
    python3 scripts/hardware/test_motors.py --find-min-speed --yes   # step up from low speed, report first that moves it
"""
