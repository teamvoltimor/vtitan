...
Usage (from ``platform/robot``, with PYTHONPATH=.)::
    ...
    python scripts/sim/diag_localization.py open
    python scripts/sim/diag_localization.py obstacles
    python scripts/sim/diag_localization.py blind
    python scripts/sim/diag_localization.py perturbed --sweep all
