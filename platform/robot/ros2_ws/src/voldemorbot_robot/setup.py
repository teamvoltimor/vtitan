...
package_name = "voldemorbot_robot"
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "bno08x_i2c_node = voldemorbot_robot.imu.bno08x.mcp2221.i2c_node:main",
            "bno08x_uart_rvc_node = voldemorbot_robot.imu.bno08x.mcp2221.uart_rvc_node:main",
            "state_machine_node = voldemorbot_robot.state_machine_node:main",
            "oled_display_node = voldemorbot_robot.oled_display_node:main",
            "ackermann_motor_node = voldemorbot_robot.motors.ackermann_motor_node:main",
