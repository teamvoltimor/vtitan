...
**Configuration:**
- `config/open_challenge.yaml` - Open challenge settings
- `config/obstacles_challenge.yaml` - Obstacles challenge settings
...
**Issues?**
- Check `simulation/README.md` for detailed usage
