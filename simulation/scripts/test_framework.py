...
class LogParser:
    ...
    def __init__(self):
        ...
        self._pending_skip_wp: Optional[int] = None
...
class ParameterTuner:
    ...
    def suggest(self, result: ScenarioResult) -> Optional[dict]:
...
class Reporter:
    ...
    def write_markdown(self, results: list[ScenarioResult], output_path: str,
                       param_history: Optional[list[dict]] = None):
...
def find_metadata(scenario_id: int, challenge: str, search_dirs: list[Path]) -> Optional[Path]:
