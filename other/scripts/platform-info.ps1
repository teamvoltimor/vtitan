...
Write-Host "Gazebo:       other/apps/gazebo/ (generator + runtime)"
Write-Host "Backend (Go): other/apps/backend/"
Write-Host "Frontend:     other/apps/frontend/"
Write-Host "Robot:        src/"
Write-Host "Proto:        other/contracts/proto/"
