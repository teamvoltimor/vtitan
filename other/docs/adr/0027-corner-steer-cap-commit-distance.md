...
This decision was replaced by [0049](0049-corner-arcs-per-corridor-and-commit-distance.md). Its content is reproduced below so this file stays self-contained; edit only the successor.
