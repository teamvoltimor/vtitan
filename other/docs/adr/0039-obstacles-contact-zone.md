...
This decision was replaced by [0061](0061-contact-zone-per-challenge.md). Its content is reproduced below so this file stays self-contained; edit only the successor.
