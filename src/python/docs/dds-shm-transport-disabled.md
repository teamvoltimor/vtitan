...
New file: `src/config/fastdds_udp_only.xml` -- a FastDDS XML
...
```
Environment=FASTRTPS_DEFAULT_PROFILES_FILE=/home/ralvarezdev/vtitan/src/config/fastdds_udp_only.xml
```
...
restart. `src/config/fastdds_udp_only.xml` can stay in place
