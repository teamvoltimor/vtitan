...
`src/python/src/vision/detector.py:184`
...
`src/python/src/hardware/hailo/streaming.py:33`
...
`src/python/src/hardware/hailo/config.py`
...
**Fixed** - `GMR_CLASS_NAMES` in `src/shared/src/shared/domain/enums.py` is
