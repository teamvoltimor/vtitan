"""Generic shipped-defaults mixin for generated-DTO-backed config models."""
...
class DefaultsModel:
    """Mixin supplying a generated-DTO-backed config model's shipped fallbacks.
    ...
    per-group TOML. A subclass therefore names each value once in
    ...
    DTO, the fallbacks come from the config layer, and neither re-declares the
    other's fields.
    """
