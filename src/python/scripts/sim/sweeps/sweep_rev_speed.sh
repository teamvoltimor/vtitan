#!/usr/bin/env bash
# Does reversing SLOWER cut obstacle pushes without costing heading?
#
...
OUT=$ROOT/other/data/archive/sweep_rev_speed
mkdir -p "$OUT"
...
ARMS=(
  ...
  "rev_015|$E|rev_speed|-0.15"
  "rev_012|$E|rev_speed|-0.12"
  "rev_010|$E|rev_speed|-0.10"
  "rev_008|$E|rev_speed|-0.08"
