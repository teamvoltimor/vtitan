...
Usage (from ``src``, with PYTHONPATH=.)::
    ...
    python scripts/bag/diag_localizer_guard_replay.py data/live/runs/run_20260804_213147
    python scripts/bag/diag_localizer_guard_replay.py data/live/runs/*  # every pulled run
"""
