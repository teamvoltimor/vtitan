...
# ~/vtitan/other/data/live/runs/run_<timestamp>/video.mp4 alongside that run's mcap bag) down
# into the shared repo-root other/data/live/videos tree for local review, WITHOUT
# the (often much larger) bag.
#
# Deliberately a separate tree from other/data/live/runs/, not a filter added to
...
VIDEOS_DIR="${VIDEOS_DIR:-$REPO_ROOT/other/data/live/videos}"
