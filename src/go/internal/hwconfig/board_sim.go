	...
	opts := boardsim.Options{
		...
		Link: boardsim.LinkConfig{
			ToBoard: boardsim.Direction{
				...
				LossRate:      loaded.ToBoard.LossRate,
				LossBurst:     loaded.ToBoard.LossBurst,
				StallRate:     loaded.ToBoard.StallRateHz,
				StallDuration: millis(loaded.ToBoard.StallMs),
			},
			ToHost: boardsim.Direction{
				...
				LossRate:      loaded.ToHost.LossRate,
				LossBurst:     loaded.ToHost.LossBurst,
				StallRate:     loaded.ToHost.StallRateHz,
				StallDuration: millis(loaded.ToHost.StallMs),
			},
