...
// control.SteeringNormFromAngleRad's clamp: a rev_steer_deg tuned larger than the physical
...
// pins control.SteeringNormFromAngleRad's other documented edge: a non-positive
