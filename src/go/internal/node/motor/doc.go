...
// pkg/driver/motor, steer pkg/driver/servo, publish MotorStatus, and enforce
...
//
// The transport-free rules (wheel angle to servo angle, speed to duty, the
// finite-command check and the watchdog's state machine) live in
// pkg/portable/actuation, shared with the Pico 2 firmware for the same
// reason; this package wires them to NATS, protobuf and the Linux drivers.
package motor
