...
//
// Like pkg/driver/motor, a display has nothing to "Read" in the sense
...
// implementing driver.Driver[T]. See src/go/pkg/driver/imu
// (rvc_driver.go) for the Config/New/Connect/Close shape this package
// follows, and pkg/driver/motor for the actuator-shaped-interface
// precedent.
//
// Package layout mirrors pkg/driver/motor: a pure, hardware-independent
