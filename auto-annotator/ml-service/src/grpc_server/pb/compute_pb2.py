...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Zegithub.com/teamvoldemor/voldemorbot/auto-annotator/api/internal/compute/pb/autoannotator/v1;computev1'
