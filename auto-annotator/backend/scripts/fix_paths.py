...
The import script ran on Windows and stored absolute Windows paths like:
    C:\\Users\\ralva\\...\\backend\\data\\images\\red_prism\\foo.jpg
...
def main() -> None:
    ...
    parser.add_argument("--from-dir", default=None, metavar="PATH",
                        help="Windows host data dir to replace (auto-detected if omitted)")
    parser.add_argument("--to-dir", default="/app/data", metavar="PATH",
