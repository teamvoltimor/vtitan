...
#
# Usage: bash ml/weights/scripts/deploy-to-ml-service.sh <name> [version]
#   bash ml/weights/scripts/deploy-to-ml-service.sh gmr          # uses LATEST
#   bash ml/weights/scripts/deploy-to-ml-service.sh gmr v1        # pin a specific version
